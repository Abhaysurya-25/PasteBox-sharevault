...
const username = `${cleanedFullname.substring(0, 4).toLowerCase()}${generateUniqueId().substring(0, 5)}`;
    ...
    return res.status(201).json({
      ...
      user: {
        ...
        totalUploads: newUser.totalUploads ?? 0,
        totalDownloads: newUser.totalDownloads ?? 0,
        videoCount: newUser.videoCount ?? 0,
        imageCount: newUser.imageCount ?? 0,
        documentCount: newUser.documentCount ?? 0,
      },
    });
  } catch (error) {
