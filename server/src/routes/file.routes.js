...
import { deleteFile, downloadInfo, downloadFile, generateQR, generateShareShortenLink, getDownloadCount, getFileDetails, getUserFiles, resolveShareLink, searchFiles, sendLinkEmail, showUserFiles, updateAllFileExpiry, updateFileExpiry, updateFilePassword, updateFileStatus, uploadFiles, verifyFilePassword, uploadFilesGuest, guestDownloadInfo, verifyGuestFilePassword, getFilePreview, getGuestFilePreview, recordFileDownload, recordGuestDownload } from "../controllers/file.controller.js";
...
router.post('/f/:shortCode/download', recordFileDownload);
router.post('/g/:shortCode/download', recordGuestDownload);
